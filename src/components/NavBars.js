...
const NavBar = () => {
  ...
  const DynamicMenu=()=>{
    if(state){
      return [
        <li  key={990} className="nav-item">
          <NavLink className="nav-link text-uppercase " aria-current="page" to={"/post"}>Posts</NavLink>
        </li>,
    ...
    <NavLink className="nav-link text-uppercase " aria-current="page" to={"/myposts"}>My All Post</NavLink>
  </li>,
